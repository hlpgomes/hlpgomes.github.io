...
# This **bold** section outlines the research *idea*. We can also cite related work here [@Wickham2014; @Baumer2017]. p value `r a4`.
...
#kable(pop_ranked[c(1, 2, 3,10),3:6], align='c', caption="Web scrapped Data from Amazon \n (sample after formatting)", booktabs = T)  ## works with knitr
...
#as_tibble(pop_ranked[1:10,3:6], align='c', caption="Web scrapped Data from Amazon \n (sample after formatting)", booktabs = T)  ## works with knitr

b <- pop_ranked[c(1, 2, 3,10),2] %>% as_tibble() %>% rename(., "Table 2: Product Name with Characteristics"=value)
b

#kable(b, align='l', caption="Product Name with Characteristics", booktabs = T)  
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, out.height= c("70%", "70%"), fig.show='hold', fig.align = "center", fig.cap="Daily Laptop Price Index"}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, out.width = "70%", fig.align = "center", fig.cap="BLS EE01 1-Month Index"}
#opts_chunk$set(echo = FALSE,
#               out.width = "75%", 
#               fig.align = "center")
...
#        rename(Nov30_Oct30=PC_1Mo_Nov30_Oct30, Nov26_Oct30=PC_1Mo_Nov26_Oct30), align='l', caption="1-Month BLS EE01 Percent Change Index", booktabs = T)  ## works with knitr
...
#kable((a2, align='c', caption="Web scrapped Data from Amazon \n (sample after formatting)", booktabs = T)  ## works with knitr
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, out.width='8cm', out.height='7cm', fig.show='hold', fig.cap='Time Series Plots'}
#par(mar = c(4, 4, 0.2, 0.1))
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, out.width='8cm', out.height='7cm', fig.show='hold', fig.align = "center"}
#opts_chunk$set(echo = FALSE,
#               out.width = "50%", 
#               fig.align = "center")
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, out.width='8cm', out.height='7cm', fig.show='hold'}
#opts_chunk$set(echo = FALSE,
#               out.width = "70%", 
#               fig.align = "center")
